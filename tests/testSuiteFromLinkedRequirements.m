function suite = testSuiteFromLinkedRequirements( links )
%TESTSUITEFROMLINKEDREQUIREMENTS Create a test suite from a set of
...
for n = 1 : numel( links ) % Loop over all links
...
end % testSuiteFromLinkedRequirements